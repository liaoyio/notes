...
export const NAV_DATA: NavData[] = [
  {
    ...
    items: [
      {
        icon: 'https://toolb.cn/favicon/emojixd.com',
        title: 'Emoji表情大全',
        desc: '归类Emoji表情和各种咨询',
      ...
      {
        icon: 'https://handraw.top/apple-touch-icon.png',
        title: 'Handraw',
        desc: '中文友好的手写效果白板工具',
      ...
      {
        icon: 'https://static.baidufe.com/fehelper/static/img/fe-128.png',
        title: 'JSON 格式化',
        desc: 'FeHelper JSON格式化工具',
        link: 'https://www.baidufe.com/fehelper/json-format/index.html',
      },
      {
        icon: 'https://snappify.com/images/logo.png',
        title: 'Snappify',
        desc: '精致的代码片段分享',
      ...
      },
      {
        ...
        title: 'Squoosh',
        desc: '基于浏览器的本地图片压缩工具（支持自定义参数和格式转换）具',
  ...
  },
  {
    ...
    items: [
      {
        icon: 'https://miro.medium.com/v2/resize:fill:176:176/0*gXNjh86g-yiSa8qJ.png',
      ...
      {
        icon: 'https://xiaolincoding.com/logo.png',
        title: '小林coding',
      ...
      {
        icon: 'https://avatars.githubusercontent.com/u/11458263?s=48&v=4',
        title: '冴羽博客',
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: '/icons/radix-ui.png',
        title: 'Radix UI',
        desc: ' 高质量的无样式组件库',
        link: 'https://www.radix-ui.com/primitives',
      },
      {
        icon: 'https://api.iconify.design/logos:mantine-icon.svg',
        title: 'Mantine UI',
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://api.iconify.design/devicon:jquery.svg',
        title: 'jQuery',
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://api.iconify.design/skill-icons:electron.svg',
        title: 'Electron',
      ...
      {
        icon: 'https://www.reactnative.cn/img/header_logo.svg',
        title: 'React Native',
        desc: '使用 React 创建 Android 和 iOS 的原生应用',
  ...
  },
  {
    ...
    items: [

      {
        ...
        title: 'MDN | Web 开发者指南',
        desc: '详细的 Web API 参考资',
        link: 'https://developer.mozilla.org/zh-CN',
      },
      {
        icon: 'https://api.iconify.design/openmoji:github.svg?color=%23888888',
        title: 'Pro Git',
        desc: 'Pro Git 中文版(第二版)',
        link: 'https://www.progit.cn/',
      },
      {
        icon: 'https://api.iconify.design/logos:typescript-icon.svg?color=%23888888',
        title: 'TypeScript',
        desc: 'TypeScript 中文文档',
        link: 'https://www.typescriptlang.org/zh/docs/',
      },
      {
        icon: 'https://devdocs.io/images/fluid-icon.png',
        title: '开发文档大全',
        desc: '收集了前后端各种语言的开发文档',
      ...
      {
        icon: 'https://ohshitgit.com/favicon-32x32.png',
        title: 'Oh Shit, Git!?!',
        desc: '解决在使用Git时碰到的问题',
        link: 'https://ohshitgit.com/zh',
      },
    ],
  },
  {
